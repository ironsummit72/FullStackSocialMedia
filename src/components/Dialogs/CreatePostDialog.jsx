...
import useReactQuery from '@/hooks/useReactQuery';
  ...
  function CreatePostDialog() {
    ...
    const handleSuggessionClick=(suggestion) => {
      ...
      const newText = `${currentText.substring(0, cursorPos - currentTag.length)}${suggestion} `;
    ...
    const left = boundingRect.left + (cursorPos - 1) * (boundingRect.width / value.length); // Adjust cursorPos by 1
